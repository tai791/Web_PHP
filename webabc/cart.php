...
<div id="content">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-9">
				<div class="card mb-3">
				  <div class="card-body">
				    ...
				    <p class="card-text text-muted">Bạn đang có <?php echo $getFromU->count_product_by_ip($ip_add); ?> sản phẩm trong giỏ hàng.</p>
							  ...
							  <table class="table table-bordered table-hover text-center">
								  ...
								  <tbody>
								    ...
								    <tr>
								      ...
								      <td class="text-right"><?php echo number_format($sub_total, 0, ',', '.'); ?> VNĐ</td>
								    </tr>
									<?php } } ?>

								    <tr>
								    	<th class="text-right" colspan="6"> Tổng </th>
								    	<th class="text-right" colspan="1"> <?php echo number_format($sub_total, 0, ',', '.'); ?> VNĐ</th>
								    </tr>
			...
			<div class="col-md-3">
				<div class="card">
				  <h5 class="card-header text-center">Tóm tắt</h5>
				  <div class="card-body">
				    ...
				    <table class="table table-hover text-center">
						  ...
						  <tbody>
						    <tr>
						      <td>Giá</td>
						      <td class="text-right"><?php echo number_format($total, 0, ',', '.'); ?> VNĐ</td>
						    </tr>
						    
						    <tr>
						      <th>Tổng</th>
						      <th class="text-right"><?php echo number_format($total, 0, ',', '.'); ?> VNĐ</th>
						    </tr>
						  </tbody>
						</table>
				  </div>
