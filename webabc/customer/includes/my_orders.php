<div class="card text-center">
	<div class="card-body">
		<h3 class="card-title mt-4">Đơn Đặt Hàng Của Bạn</h3>
		...
		<table class="table table-bordered table-responsive-xl table-hover mt-5">
			<thead>
				<tr>
					...
					<th scope="col">Đã thanh toán/ Chưa thanh toán</th>
			...
			<tbody>
				...
				?>
					...
					<tr>
						<th>#<?php echo $i; ?></th>
						<td><?php echo number_format($due_amount, 0, ',', '.'); ?> VNĐ</td>
						<td><?php echo $invoice_no; ?></td>
						<td><?php echo $qty; ?></td>
						<!-- <td><?php echo ucwords($size); ?></td> -->
						<td><?php echo $order_date; ?></td>
						<td><?php echo $order_status; ?></td>
						<td><a href="confirm.php?order_id=<?php echo $order_id; ?>" class="btn btn-sm btn-info">Xác nhận nếu đã thanh toán</a></td>
					</tr>
				<?php	} ?>
			</tbody>
		</table>
