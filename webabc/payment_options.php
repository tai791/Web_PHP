...
<div class="card">
  <div class="card-body text-center">
    ...
    <a href="order.php?c_id=<?php echo $customer_id; ?>" class="btn btn-info text-white"><i class="fas fa-hand-holding-usd"></i> Thanh Toán Khi Nhận Hàng</a>
    <a href="#" class="btn btn-info text-white"><i class="fab fa-paypal"></i> Thanh Toán Với PayPal</a>
